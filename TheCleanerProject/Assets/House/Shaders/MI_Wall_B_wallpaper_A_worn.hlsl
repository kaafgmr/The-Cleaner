...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,20.000000,0.404762,0.404762);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.404762,0.809524,-0.190476,21.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(-20.000000,5.000000,0.428857,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(439.149567,439.149567,439.149567,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(439.149567,439.149567,439.149567,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(-439.149567,-439.149567,-439.149567,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(-0.002277,-0.002277,-0.002277,0.452381);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.452381,0.452381,0.904762,-0.095238);//(Unknown)
	Material.PreshaderBuffer[9] = float4(6.000000,-5.000000,1.000000,0.471429);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.471429,0.471429,0.942858,-0.057142);//(Unknown)
	Material.PreshaderBuffer[11] = float4(2.000000,-1.000000,4.000000,0.800000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(819.200012,819.200012,819.200012,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(819.200012,819.200012,819.200012,0.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(-819.200012,-819.200012,-819.200012,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(-0.001221,-0.001221,-0.001221,0.280953);//(Unknown)
	Material.PreshaderBuffer[16] = float4(0.280953,0.280953,0.561906,-0.438094);//(Unknown)
	Material.PreshaderBuffer[17] = float4(5.000000,-4.000000,20.000000,0.300000);//(Unknown)
	Material.PreshaderBuffer[18] = float4(307.200012,307.200012,307.200012,0.000000);//(Unknown)
	Material.PreshaderBuffer[19] = float4(307.200012,307.200012,307.200012,0.000000);//(Unknown)
	Material.PreshaderBuffer[20] = float4(-307.200012,-307.200012,-307.200012,0.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(-0.003255,-0.003255,-0.003255,0.623810);//(Unknown)
	Material.PreshaderBuffer[22] = float4(0.623810,0.623810,1.247620,0.247620);//(Unknown)
	Material.PreshaderBuffer[23] = float4(21.000000,-20.000000,20.000000,0.333333);//(Unknown)
	Material.PreshaderBuffer[24] = float4(-0.666667,0.666667,0.266667,-0.133333);//(Unknown)
	...
	Material.PreshaderBuffer[31] = float4(0.244792,0.225662,0.118571,1.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.300000,1.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[33] = float4(1024.000000,1024.000000,1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[34] = float4(1024.000000,1024.000000,1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[35] = float4(-1024.000000,-1024.000000,-1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[36] = float4(-0.000977,-0.000977,-0.000977,0.404762);//(Unknown)
	Material.PreshaderBuffer[37] = float4(0.404762,0.404762,0.809524,-0.190476);//(Unknown)
	Material.PreshaderBuffer[38] = float4(1.300000,-0.300000,0.000000,0.347619);//(Unknown)
	Material.PreshaderBuffer[39] = float4(0.347619,0.347619,0.695238,-0.304762);//(Unknown)
	Material.PreshaderBuffer[40] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[41] = float4(0.244792,0.225662,0.118571,1.000000);//(Unknown)
	Material.PreshaderBuffer[42] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[43] = float4(2383393121299568906993664.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[46] = float4(2382194082934777786138624.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[47] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[48] = float4(2387220820694863638953984.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
