...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,1.000000,0.376190,0.376190);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.376190,0.752380,-0.247620,2.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(-1.000000,1.000000,0.961905,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(-0.001015,-0.001015,-0.001015,0.304762);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.304762,0.304762,0.609524,-0.390476);//(Unknown)
	Material.PreshaderBuffer[9] = float4(2.000000,-1.000000,1.000000,0.809619);//(Unknown)
	Material.PreshaderBuffer[10] = float4(829.049866,829.049866,829.049866,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(829.049866,829.049866,829.049866,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-829.049866,-829.049866,-829.049866,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(-0.001206,-0.001206,-0.001206,0.385714);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.385714,0.385714,0.771428,-0.228572);//(Unknown)
	Material.PreshaderBuffer[15] = float4(2.000000,-1.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[21] = float4(0.588542,0.544288,0.428087,0.000000);//(Unknown)
	Material.PreshaderBuffer[22] = float4(0.588542,0.544288,0.428087,0.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(0.242281,0.127438,0.072272,1.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(1.952381,0.771524,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(790.040588,790.040588,790.040588,0.000000);//(Unknown)
	Material.PreshaderBuffer[26] = float4(790.040588,790.040588,790.040588,0.000000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(-790.040588,-790.040588,-790.040588,0.000000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(-0.001266,-0.001266,-0.001266,0.310000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(0.310000,0.310000,0.620000,-0.380000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(2.952381,-1.952381,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.242281,0.127438,0.072272,1.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[33] = float4(2387497521855969282228224.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[34] = float4(2387497521855969282228224.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[35] = float4(2380395525387591104856064.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[36] = float4(2381917381773672142864384.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[37] = float4(2385007211406018492760064.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[38] = float4(2381917381773672142864384.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[39] = float4(2385007211406018492760064.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[40] = float4(3509024685661995663360.000000,0.000000,120734089216.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Normal = Local71;
	...
	MaterialFloat3 Local72 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[16].xyz,Material.PreshaderBuffer[15].z);
	MaterialFloat Local73 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local74 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local75 = MaterialStoreTexSample(Parameters, Local74, 4);
	MaterialFloat3 Local76 = (Local74.rgb * Material.PreshaderBuffer[18].xyz);
	MaterialFloat3 Local77 = (Local74.rgb * Material.PreshaderBuffer[20].xyz);
	MaterialFloat Local78 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local79 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,sampler_Material_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local80 = MaterialStoreTexSample(Parameters, Local79, 0);
	MaterialFloat3 Local81 = lerp(Local76,Local77,Local79.b);
	MaterialFloat Local82 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local83 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,sampler_Material_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local84 = MaterialStoreTexSample(Parameters, Local83, 8);
	MaterialFloat3 Local85 = (Local83.rgb * Material.PreshaderBuffer[22].xyz);
	MaterialFloat3 Local86 = lerp(Local81,Local85,Local70);
	FLWCVector3 Local87 = LWCMultiply(DERIV_BASE_VALUE(Local14), LWCPromote(Material.PreshaderBuffer[28].xyz));
	FLWCVector2 Local88 = MakeLWCVector(LWCGetX(DERIV_BASE_VALUE(Local87)), LWCGetZ(DERIV_BASE_VALUE(Local87)));
	...
	FLWCVector2 Local93 = MakeLWCVector(LWCGetY(DERIV_BASE_VALUE(Local87)), LWCGetZ(DERIV_BASE_VALUE(Local87)));
	MaterialFloat2 Local94 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local93), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local95 = MaterialStoreTexCoordScale(Parameters, Local94, 2);
	MaterialFloat4 Local96 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local94));
	MaterialFloat Local97 = MaterialStoreTexSample(Parameters, Local96, 2);
	MaterialFloat3 Local98 = lerp(Local91.rgb,Local96.rgb,Local28.r.r);
	FLWCVector2 Local99 = MakeLWCVector(LWCGetX(DERIV_BASE_VALUE(Local87)), LWCGetY(DERIV_BASE_VALUE(Local87)));
	MaterialFloat2 Local100 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local99), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local101 = MaterialStoreTexCoordScale(Parameters, Local100, 2);
	MaterialFloat4 Local102 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local100));
	MaterialFloat Local103 = MaterialStoreTexSample(Parameters, Local102, 2);
	MaterialFloat3 Local104 = lerp(Local98,Local102.rgb,Local37.r.r);
	MaterialFloat Local105 = (Local104.b + Material.PreshaderBuffer[29].w);
	MaterialFloat Local106 = lerp(Material.PreshaderBuffer[30].y,Material.PreshaderBuffer[30].x,Local105);
	MaterialFloat Local107 = saturate(Local106);
	MaterialFloat Local108 = saturate(Local107.r);
	MaterialFloat Local109 = saturate(Local108);
	MaterialFloat3 Local110 = lerp(Local86,Material.PreshaderBuffer[31].xyz,Local109);
	MaterialFloat Local111 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 7);
	MaterialFloat4 Local112 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,sampler_Material_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local113 = MaterialStoreTexSample(Parameters, Local112, 7);
	MaterialFloat4 Local114 = lerp(Local79.rgba,Local112.rgba,MaterialFloat4(MaterialFloat3(MaterialFloat2(Local70,Local70),Local70),Local70));
	MaterialFloat Local115 = (Local114.a * Material.PreshaderBuffer[31].w);
	MaterialFloat3 Local116 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local114.g),Material.PreshaderBuffer[32].x);

	PixelMaterialInputs.EmissiveColor = Local72;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local110;
	PixelMaterialInputs.Metallic = Local114.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local115;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local71;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local116;
