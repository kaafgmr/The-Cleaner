...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6] = float4(1656655968399670556753920.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1660160849773675371560960.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local14 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local11.g),Material.PreshaderBuffer[5].x);
	...
	PixelMaterialInputs.AmbientOcclusion = Local14;
