Shader "Unreal/MI_Wall_B_wallpaper_A_worn"
{
    Properties
    {
		...
		Material_Texture2D_4( "Worn BaseColor Texture", 2D ) = "white" {}
		Material_Texture2D_5( "MaskMap", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Wall_B_wallpaper_A_worn.hlsl"
