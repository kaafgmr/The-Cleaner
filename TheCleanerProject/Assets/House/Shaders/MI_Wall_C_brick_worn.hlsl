...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.285715,0.285715);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.285715,0.571430,-0.428570,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.571429,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(-0.000977,-0.000977,-0.000977,0.250000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.250000,0.250000,0.500000,-0.500000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(1.571429,-0.571429,0.380952,1.500000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1536.000000,1536.000000,1536.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1536.000000,1536.000000,1536.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-1536.000000,-1536.000000,-1536.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(-0.000651,-0.000651,-0.000651,0.223810);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.223810,0.223810,0.447620,-0.552380);//(Unknown)
	Material.PreshaderBuffer[15] = float4(1.380952,-0.380952,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[19] = float4(0.583333,0.583333,0.583333,0.000000);//(Unknown)
	Material.PreshaderBuffer[20] = float4(0.583333,0.583333,0.583333,0.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.067708,0.063967,0.043023,1.000000);//(Unknown)
	Material.PreshaderBuffer[22] = float4(0.380952,1.300000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(1331.199951,1331.199951,1331.199951,0.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(1331.199951,1331.199951,1331.199951,0.000000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(-1331.199951,-1331.199951,-1331.199951,0.000000);//(Unknown)
	Material.PreshaderBuffer[26] = float4(-0.000751,-0.000751,-0.000751,0.309524);//(Unknown)
	Material.PreshaderBuffer[27] = float4(0.309524,0.309524,0.619048,-0.380952);//(Unknown)
	Material.PreshaderBuffer[28] = float4(1.380952,-0.380952,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(0.067708,0.063967,0.043023,1.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[36] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[37] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[38] = float4(3509024685661995663360.000000,0.000000,120734089216.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local71 = lerp(Local2.rgb,Local6,Local70);
	MaterialFloat Local72 = (Local2.rgb.b + 1.00000000);
	MaterialFloat2 Local73 = (Local6.rg * ((MaterialFloat2)-1.00000000));
	MaterialFloat Local74 = dot(MaterialFloat3(Local2.rgb.rg,Local72),MaterialFloat3(Local73,Local6.b));
	MaterialFloat3 Local75 = (MaterialFloat3(Local2.rgb.rg,Local72) * ((MaterialFloat3)Local74));
	MaterialFloat3 Local76 = (((MaterialFloat3)Local72) * MaterialFloat3(Local73,Local6.b));
	MaterialFloat3 Local77 = (Local75 - Local76);
	MaterialFloat3 Local78 = lerp(Local71,Local77,Material.PreshaderBuffer[15].z);
	MaterialFloat3 Local79 = lerp(Local71,Local78,Local70);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local79;
	...
	MaterialFloat3 Local80 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[16].xyz,Material.PreshaderBuffer[15].w);
	MaterialFloat Local81 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local82 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local83 = MaterialStoreTexSample(Parameters, Local82, 4);
	MaterialFloat3 Local84 = (Local82.rgb * Material.PreshaderBuffer[18].xyz);
	MaterialFloat Local85 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local86 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,sampler_Material_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local87 = MaterialStoreTexSample(Parameters, Local86, 8);
	MaterialFloat3 Local88 = (Local86.rgb * Material.PreshaderBuffer[20].xyz);
	MaterialFloat3 Local89 = lerp(Local84,Local88,Local70);
	FLWCVector3 Local90 = LWCMultiply(DERIV_BASE_VALUE(Local14), LWCPromote(Material.PreshaderBuffer[26].xyz));
	FLWCVector2 Local91 = MakeLWCVector(LWCGetX(DERIV_BASE_VALUE(Local90)), LWCGetZ(DERIV_BASE_VALUE(Local90)));
	MaterialFloat2 Local92 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local91), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local93 = MaterialStoreTexCoordScale(Parameters, Local92, 2);
	MaterialFloat4 Local94 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local92));
	MaterialFloat Local95 = MaterialStoreTexSample(Parameters, Local94, 2);
	FLWCVector2 Local96 = MakeLWCVector(LWCGetY(DERIV_BASE_VALUE(Local90)), LWCGetZ(DERIV_BASE_VALUE(Local90)));
	MaterialFloat2 Local97 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local96), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local98 = MaterialStoreTexCoordScale(Parameters, Local97, 2);
	MaterialFloat4 Local99 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local97));
	MaterialFloat Local100 = MaterialStoreTexSample(Parameters, Local99, 2);
	MaterialFloat3 Local101 = lerp(Local94.rgb,Local99.rgb,Local28.r.r);
	FLWCVector2 Local102 = MakeLWCVector(LWCGetX(DERIV_BASE_VALUE(Local90)), LWCGetY(DERIV_BASE_VALUE(Local90)));
	MaterialFloat2 Local103 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local102), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local104 = MaterialStoreTexCoordScale(Parameters, Local103, 2);
	MaterialFloat4 Local105 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local103));
	MaterialFloat Local106 = MaterialStoreTexSample(Parameters, Local105, 2);
	MaterialFloat3 Local107 = lerp(Local101,Local105.rgb,Local37.r.r);
	MaterialFloat Local108 = (Local107.b + Material.PreshaderBuffer[27].w);
	MaterialFloat Local109 = lerp(Material.PreshaderBuffer[28].y,Material.PreshaderBuffer[28].x,Local108);
	MaterialFloat Local110 = saturate(Local109);
	MaterialFloat Local111 = saturate(Local110.r);
	MaterialFloat Local112 = saturate(Local111);
	MaterialFloat3 Local113 = lerp(Local89,Material.PreshaderBuffer[29].xyz,Local112);
	MaterialFloat Local114 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local115 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,sampler_Material_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local116 = MaterialStoreTexSample(Parameters, Local115, 0);
	MaterialFloat Local117 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 7);
	MaterialFloat4 Local118 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,sampler_Material_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local119 = MaterialStoreTexSample(Parameters, Local118, 7);
	MaterialFloat4 Local120 = lerp(Local115.rgba,Local118.rgba,MaterialFloat4(MaterialFloat3(MaterialFloat2(Local70,Local70),Local70),Local70));
	MaterialFloat Local121 = (Local120.a * Material.PreshaderBuffer[29].w);
	MaterialFloat3 Local122 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local120.g),Material.PreshaderBuffer[30].x);

	PixelMaterialInputs.EmissiveColor = Local80;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local113;
	PixelMaterialInputs.Metallic = Local120.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local121;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local79;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local122;
