...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6] = float4(1.000000,1.000000,1.000000,1.200000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = (Local7.rgb * Material.PreshaderBuffer[6].xyz);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 1);
	MaterialFloat3 Local14 = lerp(Local9,Local10,Local12.b);
	MaterialFloat Local15 = (Local12.a * Material.PreshaderBuffer[6].w);
	MaterialFloat3 Local16 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local12.g),Material.PreshaderBuffer[7].x);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local14;
	PixelMaterialInputs.Metallic = Local12.r;
	...
	PixelMaterialInputs.AmbientOcclusion = Local16;
