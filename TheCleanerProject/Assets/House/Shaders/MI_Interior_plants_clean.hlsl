...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.388295,0.432292,0.168758,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.388295,0.432292,0.168758,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(1658131707925567320883200.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(1652920502724744372551680.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1658592876527410059673600.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].y);
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local7 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,sampler_Material_Texture2D_1,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 0);
	MaterialFloat3 Local9 = (Material.PreshaderBuffer[4].xyz * Local7.rgb);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local11 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 1);
	MaterialFloat Local13 = (Local11.a * Material.PreshaderBuffer[4].w);
	MaterialFloat3 Local14 = (Local7.rgb * Material.PreshaderBuffer[6].xyz);
	MaterialFloat3 Local15 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local11.g),Material.PreshaderBuffer[7].x);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = Local7.a;
	PixelMaterialInputs.OpacityMask = Local7.a;
	PixelMaterialInputs.BaseColor = Local9;
	PixelMaterialInputs.Metallic = Local11.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local13;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local3.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local14,Material.PreshaderBuffer[6].w);
