Shader "Unreal/MI_Ceiling_planks_worn"
{
    Properties
    {
		...
		Material_Texture2D_2( "BaseColor Texture", 2D ) = "white" {}
		Material_Texture2D_3( "MaskMap", 2D ) = "white" {}
		Material_Texture2D_4( "Worn BaseColor Texture", 2D ) = "white" {}
		Material_Texture2D_5( "MultiMask Texture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Ceiling_planks_worn.hlsl"
