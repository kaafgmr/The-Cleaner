Shader "Unreal/MI_Exterior_railing_white_clean"
{
    Properties
    {
		...
		Material_Texture2D_1( "BaseColorTexture", 2D ) = "white" {}
		Material_Texture2D_2( "MaskMap", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Exterior_railing_white_clean.hlsl"
