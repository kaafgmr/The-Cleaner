...
float4  Texture2DSampleBias( Texture2D Tex, SamplerState Sampler, float2 UV, float  MipBias )
{
	...
	MaterialFloat4 Texture2DArraySample(Texture2DArray Tex, SamplerState Sampler, float3 UV)
	{
			...
			//return UNITY_SAMPLE_TEX2DARRAY( _MyArr, UV);
		#endif
	}
	...
	#else
		//return UNITY_SAMPLE_CUBEARRAY_BIAS( Tex, UV, MipBias );
	#endif
	}
	...
	#else
		//return UNITY_SAMPLE_TEX2DARRAY( Tex, Sampler );
	#endif
	}
#endif
...
FPrimitiveSceneData GetPrimitiveData( uint PrimitiveId )
{
	...
	LocalToWorld[ 3 ] = View.PrimitiveSceneData[ PrimitiveBaseOffset + 3 ];
		...
		PrimitiveData.ObjectRadius = 1.0;
