...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(-0.000977,-0.000977,-0.000977,0.320000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.320000,0.320000,0.640000,-0.360000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(2.000000,-1.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[10] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[15] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[23] = float4(3509024685661995663360.000000,0.000000,120734089216.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local41 = saturate(Local40);
	MaterialFloat3 Local42 = lerp(Local2.rgb,Local6,Local41);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local42;
	...
	MaterialFloat3 Local43 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[8].xyz,Material.PreshaderBuffer[7].z);
	MaterialFloat Local44 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local45 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local46 = MaterialStoreTexSample(Parameters, Local45, 4);
	MaterialFloat3 Local47 = (Local45.rgb * Material.PreshaderBuffer[10].xyz);
	MaterialFloat3 Local48 = (Local45.rgb * Material.PreshaderBuffer[12].xyz);
	MaterialFloat Local49 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local50 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,sampler_Material_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local51 = MaterialStoreTexSample(Parameters, Local50, 0);
	MaterialFloat3 Local52 = lerp(Local47,Local48,Local50.b);
	MaterialFloat Local53 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local54 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,sampler_Material_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local55 = MaterialStoreTexSample(Parameters, Local54, 8);
	MaterialFloat3 Local56 = (Local54.rgb * Material.PreshaderBuffer[14].xyz);
	MaterialFloat3 Local57 = lerp(Local52,Local56,Local41);
	MaterialFloat Local58 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 7);
	MaterialFloat4 Local59 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,sampler_Material_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local60 = MaterialStoreTexSample(Parameters, Local59, 7);
	MaterialFloat4 Local61 = lerp(Local50.rgba,Local59.rgba,MaterialFloat4(MaterialFloat3(MaterialFloat2(Local41.x,Local41.x),Local41.x),Local41.x));
	MaterialFloat Local62 = (Local61.a * Material.PreshaderBuffer[14].w);
	MaterialFloat3 Local63 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local61.g),Material.PreshaderBuffer[15].x);

	PixelMaterialInputs.EmissiveColor = Local43;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local57;
	PixelMaterialInputs.Metallic = Local61.r;
	...
	PixelMaterialInputs.AmbientOcclusion = Local63;
