...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,1.000000,0.500000,0.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.500000,1.000000,0.000000,2.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(2.000000,-1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[13] = float4(-0.000977,-0.000977,-0.000977,0.500000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(0.500000,0.500000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[19] = float4(0.760417,0.739495,0.590900,0.000000);//(Unknown)
	Material.PreshaderBuffer[20] = float4(0.760417,0.739495,0.590900,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[22] = float4(2385053328266202766639104.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(2385053328266202766639104.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(2385514496868045505429504.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[26] = float4(2385514496868045505429504.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(2388742677080944676962304.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(2388742677080944676962304.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(3509024685661995663360.000000,0.000000,120734089216.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[32] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local77 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local78 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,sampler_Material_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local79 = MaterialStoreTexSample(Parameters, Local78, 8);
	MaterialFloat3 Local80 = (Local78.rgb * Material.PreshaderBuffer[20].xyz);
	MaterialFloat3 Local81 = lerp(Local76,Local80,Local70);
	MaterialFloat Local82 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local83 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,sampler_Material_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local84 = MaterialStoreTexSample(Parameters, Local83, 0);
	MaterialFloat Local85 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 7);
	MaterialFloat4 Local86 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,sampler_Material_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local87 = MaterialStoreTexSample(Parameters, Local86, 7);
	MaterialFloat4 Local88 = lerp(Local83.rgba,Local86.rgba,MaterialFloat4(MaterialFloat3(MaterialFloat2(Local70,Local70),Local70),Local70));
	MaterialFloat Local89 = (Local88.a * Material.PreshaderBuffer[20].w);
	MaterialFloat3 Local90 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local88.g),Material.PreshaderBuffer[21].x);

	PixelMaterialInputs.EmissiveColor = Local72;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local81;
	PixelMaterialInputs.Metallic = Local88.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local89;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local71;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local90;
