...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(-0.150000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1654165657949719767285760.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1654119541089535493406720.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(1653612255627508480737280.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 2);
	...
	MaterialFloat Local13 = (1.00000000 - Local11.a);
	MaterialFloat Local14 = PositiveClampedPow(Local13,Material.PreshaderBuffer[4].w);
	MaterialFloat Local15 = (Material.PreshaderBuffer[5].x * Local7.a);
	MaterialFloat Local16 = (Local15 + Local7.a);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = Local16;
	...
	PixelMaterialInputs.AmbientOcclusion = Local11.g;
	PixelMaterialInputs.Refraction = MaterialFloat2(1.00000000.rr.x,Material.PreshaderBuffer[5].y);
