...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,20.000000,0.371429,0.371429);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.371429,0.742858,-0.257142,21.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(-20.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1024.000000,1024.000000,1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1024.000000,1024.000000,1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(-1024.000000,-1024.000000,-1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(-0.000977,-0.000977,-0.000977,0.500000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.500000,0.500000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(2.000000,-1.000000,10.285715,0.566667);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.566667,0.566667,1.133334,0.133334);//(Unknown)
	Material.PreshaderBuffer[11] = float4(11.285715,-10.285715,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1024.000000,1024.000000,1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(1024.000000,1024.000000,1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(-1024.000000,-1024.000000,-1024.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(-0.000977,-0.000977,-0.000977,0.500000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(0.500000,0.500000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(2.000000,-1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[21] = float4(-0.000977,-0.000977,-0.000977,0.561905);//(Unknown)
	Material.PreshaderBuffer[22] = float4(0.561905,0.561905,1.123810,0.123810);//(Unknown)
	Material.PreshaderBuffer[23] = float4(2.000000,-1.000000,13.314286,0.571429);//(Unknown)
	Material.PreshaderBuffer[24] = float4(-0.428571,0.428571,0.171428,-0.228572);//(Unknown)
	Material.PreshaderBuffer[25] = float4(14.314286,-13.314286,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[31] = float4(0.020833,0.018799,0.007412,1.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.000000,0.809619,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[36] = float4(-0.001206,-0.001206,-0.001206,0.180952);//(Unknown)
	Material.PreshaderBuffer[37] = float4(0.180952,0.180952,0.361904,-0.638096);//(Unknown)
	Material.PreshaderBuffer[38] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[39] = float4(0.020833,0.018799,0.007412,1.000000);//(Unknown)
	Material.PreshaderBuffer[40] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[41] = float4(2382563017816251977170944.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[42] = float4(2389203845682787415752704.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[43] = float4(2388927144521681772478464.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[44] = float4(2385422263147676957671424.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[45] = float4(2388050924178180568776704.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[46] = float4(2385376146287492683792384.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[47] = float4(2383669822460674550267904.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local109 = (Local2.rgb.b + 1.00000000);
	MaterialFloat2 Local110 = (Local6.rg * ((MaterialFloat2)-1.00000000));
	MaterialFloat Local111 = dot(MaterialFloat3(Local2.rgb.rg,Local109),MaterialFloat3(Local110,Local6.b));
	MaterialFloat3 Local112 = (MaterialFloat3(Local2.rgb.rg,Local109) * ((MaterialFloat3)Local111));
	MaterialFloat3 Local113 = (((MaterialFloat3)Local109) * MaterialFloat3(Local110,Local6.b));
	MaterialFloat3 Local114 = (Local112 - Local113);
	MaterialFloat3 Local115 = lerp(Local108,Local114,Material.PreshaderBuffer[25].z);
	MaterialFloat3 Local116 = lerp(Local108,Local115,Local107);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local116;
	...
	MaterialFloat3 Local117 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[26].xyz,Material.PreshaderBuffer[25].w);
	MaterialFloat Local118 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local119 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local120 = MaterialStoreTexSample(Parameters, Local119, 4);
	MaterialFloat3 Local121 = (Local119.rgb * Material.PreshaderBuffer[28].xyz);
	MaterialFloat Local122 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local123 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,sampler_Material_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local124 = MaterialStoreTexSample(Parameters, Local123, 8);
	MaterialFloat3 Local125 = (Local123.rgb * Material.PreshaderBuffer[30].xyz);
	MaterialFloat3 Local126 = lerp(Local121,Local125,Local107);
	FLWCVector3 Local127 = LWCMultiply(DERIV_BASE_VALUE(Local14), LWCPromote(Material.PreshaderBuffer[36].xyz));
	FLWCVector2 Local128 = MakeLWCVector(LWCGetX(DERIV_BASE_VALUE(Local127)), LWCGetZ(DERIV_BASE_VALUE(Local127)));
	MaterialFloat2 Local129 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local128), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local130 = MaterialStoreTexCoordScale(Parameters, Local129, 2);
	MaterialFloat4 Local131 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local129));
	MaterialFloat Local132 = MaterialStoreTexSample(Parameters, Local131, 2);
	FLWCVector2 Local133 = MakeLWCVector(LWCGetY(DERIV_BASE_VALUE(Local127)), LWCGetZ(DERIV_BASE_VALUE(Local127)));
	MaterialFloat2 Local134 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local133), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local135 = MaterialStoreTexCoordScale(Parameters, Local134, 2);
	MaterialFloat4 Local136 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local134));
	MaterialFloat Local137 = MaterialStoreTexSample(Parameters, Local136, 2);
	MaterialFloat3 Local138 = lerp(Local131.rgb,Local136.rgb,Local28.r.r);
	FLWCVector2 Local139 = MakeLWCVector(LWCGetX(DERIV_BASE_VALUE(Local127)), LWCGetY(DERIV_BASE_VALUE(Local127)));
	MaterialFloat2 Local140 = LWCApplyAddressMode(DERIV_BASE_VALUE(Local139), LWCADDRESSMODE_WRAP, LWCADDRESSMODE_WRAP);
	MaterialFloat Local141 = MaterialStoreTexCoordScale(Parameters, Local140, 2);
	MaterialFloat4 Local142 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(sampler_Material_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),Local140));
	MaterialFloat Local143 = MaterialStoreTexSample(Parameters, Local142, 2);
	MaterialFloat3 Local144 = lerp(Local138,Local142.rgb,Local37.r.r);
	MaterialFloat Local145 = (1.00000000 - Local144.b);
	MaterialFloat Local146 = (Local145 + Material.PreshaderBuffer[37].w);
	MaterialFloat Local147 = lerp(Material.PreshaderBuffer[38].y,Material.PreshaderBuffer[38].x,Local146);
	MaterialFloat Local148 = saturate(Local147);
	MaterialFloat Local149 = saturate(Local148.r);
	MaterialFloat Local150 = saturate(Local149);
	MaterialFloat3 Local151 = lerp(Local126,Material.PreshaderBuffer[39].xyz,Local150);
	MaterialFloat Local152 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local153 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,sampler_Material_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local154 = MaterialStoreTexSample(Parameters, Local153, 0);
	MaterialFloat Local155 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 7);
	MaterialFloat4 Local156 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,sampler_Material_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local157 = MaterialStoreTexSample(Parameters, Local156, 7);
	MaterialFloat4 Local158 = lerp(Local153.rgba,Local156.rgba,MaterialFloat4(MaterialFloat3(MaterialFloat2(Local107.x,Local107.x),Local107.x),Local107.x));
	MaterialFloat Local159 = (Local158.a * Material.PreshaderBuffer[39].w);
	MaterialFloat3 Local160 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local158.g),Material.PreshaderBuffer[40].x);

	PixelMaterialInputs.EmissiveColor = Local117;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local151;
	PixelMaterialInputs.Metallic = Local158.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local159;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local116;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local160;
