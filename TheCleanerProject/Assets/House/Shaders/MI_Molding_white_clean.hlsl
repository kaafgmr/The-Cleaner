...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,3.000000,0.220000,0.220000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.220000,0.440000,-0.560000,4.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(-3.000000,20.000000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(-0.000977,-0.000977,-0.000977,0.352381);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.352381,0.352381,0.704762,-0.295238);//(Unknown)
	Material.PreshaderBuffer[9] = float4(21.000000,-20.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[18] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[19] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[20] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[22] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(-0.000000,0.000000,3509024685661995663360.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(3509024685661995663360.000000,0.000000,120734089216.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local46 = (((MaterialFloat3)Local45) + saturate(MaterialFloat3(0.00000000,0.00000000,0.00000000)));
	MaterialFloat3 Local47 = saturate(Local46);
	MaterialFloat3 Local48 = saturate(Local47);
	MaterialFloat3 Local49 = lerp(Local2.rgb,Local6,Local48);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local49;
	...
	MaterialFloat3 Local50 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[10].xyz,Material.PreshaderBuffer[9].z);
	MaterialFloat Local51 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local52 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local53 = MaterialStoreTexSample(Parameters, Local52, 4);
	MaterialFloat3 Local54 = (Local52.rgb * Material.PreshaderBuffer[12].xyz);
	MaterialFloat3 Local55 = (Local52.rgb * Material.PreshaderBuffer[14].xyz);
	MaterialFloat Local56 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local57 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,sampler_Material_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local58 = MaterialStoreTexSample(Parameters, Local57, 0);
	MaterialFloat3 Local59 = lerp(Local54,Local55,Local57.b);
	MaterialFloat Local60 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 8);
	MaterialFloat4 Local61 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,sampler_Material_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local62 = MaterialStoreTexSample(Parameters, Local61, 8);
	MaterialFloat3 Local63 = (Local61.rgb * Material.PreshaderBuffer[16].xyz);
	MaterialFloat3 Local64 = lerp(Local59,Local63,Local48);
	MaterialFloat Local65 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 7);
	MaterialFloat4 Local66 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,sampler_Material_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local67 = MaterialStoreTexSample(Parameters, Local66, 7);
	MaterialFloat4 Local68 = lerp(Local57.rgba,Local66.rgba,MaterialFloat4(MaterialFloat3(MaterialFloat2(Local48.x,Local48.x),Local48.x),Local48.x));
	MaterialFloat Local69 = (Local68.a * Material.PreshaderBuffer[16].w);
	MaterialFloat3 Local70 = lerp(MaterialFloat3(1.00000000,1.00000000,1.00000000),((MaterialFloat3)Local68.g),Material.PreshaderBuffer[17].x);

	PixelMaterialInputs.EmissiveColor = Local50;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local64;
	PixelMaterialInputs.Metallic = Local68.r;
