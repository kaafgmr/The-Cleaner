Shader "Unreal/MI_Wallpanel_exterior_white_clean"
{
    Properties
    {
		...
		Material_Texture2D_1( "Worn Normal", 2D ) = "white" {}
		Material_Texture2D_2( "MultiMask Texture", 2D ) = "white" {}
		Material_Texture2D_3( "BaseColor Texture", 2D ) = "white" {}
		Material_Texture2D_4( "MaskMap", 2D ) = "white" {}
		Material_Texture2D_5( "Worn BaseColor Texture", 2D ) = "white" {}
		Material_Texture2D_6( "Worn MaskMap ", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Wallpanel_exterior_white_clean.hlsl"
