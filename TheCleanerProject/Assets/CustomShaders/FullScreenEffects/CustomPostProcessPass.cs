...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        //---Custom effect here---
        var customEffect = stack.GetComponent<ColorBlindComponent>();
        ...
        if (customEffect.IsActive())
        {
            ...
            material.SetColor("_R", customEffect.RGB[(int)customEffect.mode.value, 0]);
            material.SetColor("_G", customEffect.RGB[(int)customEffect.mode.value, 1]);
            material.SetColor("_B", customEffect.RGB[(int)customEffect.mode.value, 2]);
